    ...
    public static Node reverse(Node head, int k) {
        ...
        while (current != null) {
            ...
            if (count < k && temp == null) {
                // If the last group has less than k nodes, we still reverse it
                Node prev = null;
                Node current_rev = groupHead;
                while (current_rev != null) {
                    Node next_node = current_rev.next;
                    current_rev.next = prev;
                    prev = current_rev;
                    current_rev = next_node;
                }
                prevTail.next = prev;
                break;
            }
            ...
            prevTail.next = prev;
            groupHead.next = next_group_head;
            prevTail = groupHead;
